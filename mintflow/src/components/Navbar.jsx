...
const Navbar = () => {
  return (
    <nav className="h-[70px] relative w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-30 bg-gradient-to-r from-rich to-flow transition-all">
      ...
      <button type="button" className="bg-white text-gray-700 md:inline font-abritl hover:text-white cursor-pointer hidden text-sm hover:bg-mint/50 active:scale-95 transition-all w-40 h-11 rounded-full">
        Sign Out
      </button>
